...
The current implementation focus is completing the deterministic forward path.
...
- Resolve source profiles into derived calculation states only under explicit representative-value rules.
